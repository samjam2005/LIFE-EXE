    ...
    <div className="report">
      ...
      <div className="report__body">
        ...
        <p className="report__disclaimer">
          ⓘ Generated by RxReady to help you communicate with your doctor. Not a diagnosis or medical advice.
        </p>
      </div>
    </div>
  );
...
export default function App() {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      try {
        ...
        setMessages([{ role: 'assistant', content: "Hi, I'm RxReady. I'll help you prepare for your doctor's appointment. What's brought you in today?" }]);
      }
      setLoading(false);
    };
    init();
  ...
  if (phase === 'report' && reportData) {
    return <ReportView data={reportData} onBack={() => setPhase('chat')} />;
  }
      ...
      <header className="header">
        <div className="header__brand">
          ...
          <div className="header__text">
            <span className="header__name">RxReady</span>
